...
console.log("STARTED!!22222")
    ...
    console.log("create paymetn request is going")
    const {
      error: backendError,
      clientSecret
    ...
    form.addEventListener('submit', async (e) => {
      ...
      console.log(`${window.location.origin}/return.html`)
      // const { error:stripeError } = await stripe.confirmPayment({
      //   clientSecret:{clientSecret},
      //   payment_method: {
      //     card: elements.getElement('card'), // Assuming you're using a card element
      //   },
      //   return_url: `${window.location.origin}/return.html`,
      //   // Other confirmParams properties can be added here as needed
      // });
